...
(function () {
  ...
  function initFooterSocials() {
    ...
    socials.style.cssText = 'display:flex;justify-content:center;gap:20px;margin-top:16px;';
    socials.innerHTML =
      '<a href="https://discord.gg/cerberus" target="_blank" rel="noopener" style="color:var(--text-dim);text-decoration:none;font-size:0.78rem;display:flex;align-items:center;gap:6px;transition:color 0.2s;" onmouseover="this.style.color=\'#5865F2\'" onmouseout="this.style.color=\'var(--text-dim)\'">' +
        ...
        'Discord</a>' +
      '<a href="https://x.com/cerberusac" target="_blank" rel="noopener" style="color:var(--text-dim);text-decoration:none;font-size:0.78rem;display:flex;align-items:center;gap:6px;transition:color 0.2s;" onmouseover="this.style.color=\'var(--text-bright)\'" onmouseout="this.style.color=\'var(--text-dim)\'">' +
        '<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>' +
        'X / Twitter</a>' +
      '<a href="https://github.com/ACCerberus" target="_blank" rel="noopener" style="color:var(--text-dim);text-decoration:none;font-size:0.78rem;display:flex;align-items:center;gap:6px;transition:color 0.2s;" onmouseover="this.style.color=\'var(--text-bright)\'" onmouseout="this.style.color=\'var(--text-dim)\'">' +
    ...
    var copyright = footer.querySelector('p:last-child');
    if (copyright) footer.insertBefore(socials, copyright);
